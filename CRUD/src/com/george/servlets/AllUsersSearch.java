...
@WebServlet("/AllUsersSearch")
public class AllUsersSearch extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		for (int i = 0; i < quieries.size(); i++) {
			...
			source += "<tr>" 
						+ "<td>" + quieries.get(i).getId()  +"</td>" 
						+ "<td>" + quieries.get(i).getFirstName() + "</td>" 
						+ "<td>" + quieries.get(i).getLastName() + "</td>" 
						+ "<td>" + quieries.get(i).getDateOfBirth() + "</td>" 
						+ "<td>" + quieries.get(i).getPhoneNumber() + "</td>"
						+ "<td>" + quieries.get(i).getEmail() + "</td>" 
					+ "</tr>";
		}
